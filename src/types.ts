...
export interface RebuildState {
  ...
  /** Cumulative performance log across all sessions */
  cumulativeLog?: DatabaseLog;
...
/**
 * Session information for tracking multi-session rebuilds
 */
export interface SessionInfo {
  ...
  startTime: string;
  /** Session end time ISO string (if completed) */
  endTime?: string;
  /** Total time spent in this session (seconds) */
  totalTimeSeconds: number;
  /** Number of indexes rebuilt in this session */
...
export interface DatabaseLog {
  ...
  errorStack?: string;
  /** Session history for multi-session rebuilds */
